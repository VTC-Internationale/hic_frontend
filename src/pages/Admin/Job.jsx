  ...
  return (
    <div>
        <header className='px-8 py-4 md:py-8 lg:py-10 border-b flex items-center justify-between'>
            ...
            <h1 className='text-xl font-bold'>Civil Engineering</h1>
        </header>
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 border">
                    ...
                    <tbody>
                        <tr className="bg-white border-b ">
                            ...
                            <td className="py-4 px-6 font-light flex items-center space-x-2 cursor-pointer">
                                <span>
                            ...
                            <td className="py-4 px-6">
                                <div>
                                    <select name="job_status" className='bg-blue-500/50 text-gray-700 outline-none px-2 py-1 rounded-full'>
                        ...
                        <tr className="bg-white border-b ">
                            ...
                            <td className="py-4 px-6">
                                <div>
                                    <select name="job_status" className='bg-green-500/50 text-gray-700 outline-none px-2 py-1 rounded-full'>
                                        <option value="accepted">Accepted</option>
                                        <option value="interviewing">Interviewing</option>
                                        <option value="rejected">Rejected</option>
                                    </select>
                        ...
                        <tr className="bg-white border-b ">
                            ...
                            <td className="py-4 px-6">
                                <div>
                                    <select name="job_status" className='bg-red-500/50 text-gray-700 outline-none px-2 py-1 rounded-full'>
                                        <option value="rejected">Rejected</option>
                                        <option value="interviewing">Interviewing</option>
                                        <option value="accepted">Accepted</option>
                                    </select>
