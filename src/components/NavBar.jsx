...
const NavBar = () => {
  ...
  return (
    <div className='w-full '>
        <nav className='hidden md:flex items-center py-4 text-white justify-between px-4'>
                <Link to="/">
                ...
                <ul className='flex items-center'>
                    <Link to="/" className='py-2 px-2 nav-item'>
                        <li>HOME</li>
                        <div className='h-[2px] transition-all duration-600 w-0 bg-white'></div>
                    </Link>
                    <Link to="/about" className='py-2 px-2 nav-item'>
                        <li>ABOUT</li>
                        <div className='h-[2px] transition-all duration-600 w-0 bg-white'></div>
                    </Link>
                    {/* <Link to="/services" className='py-2 px-2 nav-item'>
                        <li>SERVICES</li>
                        <div className='h-[2px] transition-all duration-600 w-0 bg-white'></div>
                    </Link> */}
                    <Link to="/my-jobs" className='py-2 px-2 nav-item'>
                        <li>JOBS</li>
                        <div className='h-[2px] transition-all duration-600 w-0 bg-white'></div>
                    </Link>
                </ul>
        ...
        <nav className={`relative md:hidden flex items-center py-4 text-white justify-between px-4 ${toggle && "bg-white border-b"}`}>
                ...
                <div className={`absolute w-full top-20 bg-white text-[#38406F] left-0 transition-all duration-700 ${!toggle? "-translate-y-[30rem]" : ""}`}>
                    <ul className='flex px-8 flex-col pt-4'>
                        <Link to="/" className='py-2 px-2 nav-item'>
                            <li>HOME</li>
                            <div className='h-[2px] transition-all duration-600 w-0 bg-[#38406F]'></div>
                        </Link>
                        <Link to="/about" className='py-2 px-2 nav-item'>
                            <li>ABOUT</li>
                            <div className='h-[2px] transition-all duration-600 w-0 bg-[#38406F]'></div>
                    ...
                    <div className=' px-8 pb-4'>
                        ...
                        <Link to="/login" className=' w-full text-white px-2'>
